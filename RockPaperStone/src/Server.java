...
public class Server {
     ...
     *
     */
    private static String welcomeMsg = "--- Welcome to Rock Paper Scissors Server Version  " + versionNumber + " --- \n";
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (!welcomeSocket.isClosed()) {
            ...
            if (client_1.isConnected()) {
                System.out.println("\nClient one (" + (client_1.getLocalAddress().toString()).substring(1) + ":"
                        + client_1.getLocalPort() + ") has joined ... waiting for another client ...");
            }
            ...
            if (client_2.isConnected()) {
                System.out.println("Client two (" + (client_2.getLocalAddress().toString()).substring(1) + ":"
